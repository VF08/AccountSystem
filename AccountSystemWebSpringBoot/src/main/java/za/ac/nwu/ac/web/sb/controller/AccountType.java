...
public class AccountType {
    public class AccountTypeController {
        ...
        private final FetchAccountType fetchAccountType;
        private final CreateAccountType createAccountType;

        @Autowired
        public AccountTypeController(FetchAccountType fetchAccountTypeFlow, @Qualifier("CreateAccountTypeFlowName") CreateAccountType createAccountType) {
            this.fetchAccountType = fetchAccountTypeFlow;
        ...
        public ResponseEntity<GeneralResponse<List<AccountTypeDto>>> getAll() {
            List<AccountTypeDto> accountTypes = fetchAccountType.getAllAccounTypes();
        ...
        public ResponseEntity<GeneralResponse<AccountTypeDto>> getAccountType(
            ...
            AccountTypeDto accountType = fetchAccountType.getAccountTypeByMnemonic(mnemonic);
        ...
        public ResponseEntity<GeneralResponse<AccountTypeDto>> deleteAccountType(
                @ApiParam(value = "The mnemonic that uniquely identifies the AccountType.",
                        ...
                        required = true)
                @PathVariable("mnemonic") final String mnemonic) {
            AccountTypeDto accountType = ModifyAccountType.delAccountType(mnemonic);
            GeneralResponse<AccountTypeDto> response = new GeneralResponse<>(true, accountType);
            return new ResponseEntity<>(response, HttpStatus.OK);
        }
        ...
        public ResponseEntity<GeneralResponse<AccountTypeDto>> updateAccountType(
            ...
            AccountTypeDto accountType = ModifyAccountType.updateAccountType(mnemonic, newAccountTypeName, newCreationDate);
            GeneralResponse<AccountTypeDto> response = new GeneralResponse<>(true, accountType);
            return new ResponseEntity<>(response, HttpStatus.OK);
        }
    }
